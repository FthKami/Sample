...
@EnableJpaRepositories(basePackages = { "myProject"})
public class DataSourceConfig {
    ...
    public DataSource devDataSource(){
        ...
        hikariDataSource.setJdbcUrl("jdbc:oracle:thin:@<IP>:1521:orcl");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        entityManagerFactoryBean.setPackagesToScan("myProject");
